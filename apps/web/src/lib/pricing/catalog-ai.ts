...
function aiSku(
  ...
  cost: number,
  capabilityId: string,
  extra?: { allowZero?: boolean; commercialAvailability?: CatalogItem["commercialAvailability"] }
): CatalogItem {
  return fixedSku({
    sku,
    name,
    ...
    capabilityId,
    commercialAvailability: extra?.commercialAvailability ?? "PURCHASABLE",
...
export const AI_CATALOG: CatalogItem[] = [
  ...
  aiSku("AI-T09", "Assistente de emergência", "Evento", 14.9, 4.5, "pfo.emergency_assistant"),
  aiSku("AI-T10", "Organizador de laudos", "Evento", 19.9, 5.5, "pfo.report_organizer"),
  aiSku("AI-T11", "Assistente de medicamentos", "Evento", 9.9, 2.5, "pfo.medication_assistant"),
  aiSku("AI-T12", "Assistente de tratamento", "Mês", 19.9, 6, "pfo.treatment_assistant"),
  aiSku("AI-T13", "Assistente de exames", "Evento", 14.9, 4, "pfo.exam_assistant"),
  aiSku("AI-T14", "Assistente multilíngue", "Mês", 19.9, 6, "pfo.multilingual_assistant"),
  ...
  aiSku("AI-P11", "Cobrança e conciliação", "Parceiro / mês", 99.9, 26, "pfo.billing_agent"),
  aiSku("AI-P12", "Forecast e relatórios", "Parceiro / mês", 129.9, 34, "pfo.forecast_agent"),
  aiSku("AI-P13", "Recuperação de clientes", "Parceiro / mês", 89.9, 23, "pfo.winback_agent"),
  aiSku("AI-P14", "Reputação", "Parceiro / mês", 69.9, 18, "pfo.reputation_agent"),
  aiSku("AI-C01", "Transcrição clínica", "Hora", 24.9, 7.5, "pfo.clinical_transcription"),
  aiSku("AI-C02", "Resumo clínico", "Evento", 19.9, 6, "pfo.clinical_summary"),
  aiSku("AI-C03", "Estruturação de prontuário", "Clínica / mês", 149.9, 40, "pfo.record_structuring"),
  aiSku("AI-C04", "IA radiológica", "Exame", 39.9, 12, "pfo.radiology_assistive"),
  aiSku("AI-C05", "Revisão humana radiológica", "Exame", 149.9, 95, "pfo.radiology_human_review", {
