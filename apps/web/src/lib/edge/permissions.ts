/**
 * Permissões por role para Edge Runtime (middleware).
 * Espelha lib/permissions.ts — manter sincronizado ao alterar matriz de rotas.
 */
import type { AppRole } from "@/lib/edge/types";
