...
export const TURNSTILE_PUBLIC_MESSAGES: Record<TurnstileErrorCode, string> = {
  ...
  TOKEN_INVALID: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  TOKEN_MALFORMED: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  TOKEN_EXPIRED: "Verificação expirada. Conclua o desafio novamente.",
  TOKEN_REUSED: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  ACTION_MISMATCH: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  HOSTNAME_MISMATCH: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  CLOUDFLARE_REJECTED: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  ...
  BYPASS_FORBIDDEN: "Não foi possível concluir a verificação de segurança. Tente novamente.",
  UNEXPECTED: "Não foi possível concluir a verificação de segurança. Tente novamente.",
};
