...
export const PARTNER_NAV_ITEMS: PartnerNavItem[] = [
  ...
  { href: "/partner/planos", label: "Planos Pro", description: "Assinatura, Ads e add-ons", icon: DollarSign, requiresApproval: true },
  { href: "/partner/ads", label: "Ads", description: "Visibilidade e tráfego", icon: Sparkles, requiresApproval: true },
  { href: "/partner/teleconsulta", label: "Teleconsulta", description: "Casos clínicos e laudos", icon: Headphones, requiresApproval: true },
