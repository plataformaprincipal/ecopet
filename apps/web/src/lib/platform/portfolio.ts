...
export const ECCOPET_PORTFOLIO: PortfolioSuite[] = [
  ...
  { id: "ads", name: "EccoPet Ads", status: "PARTIAL", commercial: true, dependency: "Fee interno PURCHASABLE; mídia pass-through CATALOG_ONLY" },
  { id: "one", name: "EccoPet One", status: "ACTIVE", commercial: true, dependency: "Checkout Mercado Pago + CatalogSubscription" },
  { id: "care", name: "EccoPet Care", status: "PARTIAL", commercial: true, dependency: "Digitais PURCHASABLE; teleconsulta PARTNER_REQUIRED" },
  { id: "protect", name: "EccoPet Protect", status: "PARTNER_REQUIRED", commercial: true, dependency: "Operador/seguradora autorizado" },
