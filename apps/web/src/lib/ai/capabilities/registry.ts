...
export const B2C_CAPABILITIES: AiCapabilityDefinition[] = [
  {
    ...
    tools: ["consult_products", "consult_services", "consult_cart", "consult_orders", "consult_agenda", "request_client_action", "generate_image"],
    requirements: {},
  ...
  },
  {
    ...
    tools: ["request_client_action", "generate_image"],
    requirements: { login: true },
