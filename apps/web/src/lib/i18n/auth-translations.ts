...
const VALIDATION_MESSAGE_KEYS: Record<string, TranslationKey> = {
  ...
  "Informe o CNPJ.": "auth.validation.cnpjEmpty",
  "Continue digitando o CNPJ.": "auth.validation.cnpjIncomplete",
  "Confira o CNPJ informado.": "auth.validation.cnpjStructure",
  "CNPJ com dígitos verificadores inválidos.": "auth.validation.cnpjCheckDigit",
  "Não conseguimos consultar os dados automaticamente. Você pode continuar preenchendo-os manualmente.":
    "auth.validation.cnpjLookupUnavailable",
  "CNPJ localizado.": "auth.validation.cnpjLookupFound",
  "Consultando dados da empresa…": "auth.validation.cnpjLookupLoading",
