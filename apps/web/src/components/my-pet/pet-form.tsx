    ...
    <Card>
      ...
      <CardContent>
        ...
        >
          ...
          <div className="sm:col-span-2">
            <label className="text-sm font-medium">URL da foto principal</label>
            <Input className="mt-1" placeholder="https://..." value={form.photo ?? ""} onChange={(e) => set("photo", e.target.value)} />
          </div>
          <div className="sm:col-span-2">
