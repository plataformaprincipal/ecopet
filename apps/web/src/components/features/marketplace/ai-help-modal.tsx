...
export function AiHelpModal() {
  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 z-50 w-[min(420px,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-2xl border bg-white p-6 shadow-2xl dark:bg-[#0f1419]">
