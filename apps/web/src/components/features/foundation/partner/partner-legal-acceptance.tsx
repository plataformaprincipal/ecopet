...
export function PartnerLegalAcceptance({
  ...
  const legalMap = {
    terms: PARTNER_LEGAL.terms,
    privacy: PARTNER_LEGAL.privacy,
  };

  return (
    <section
      aria-labelledby="partner-legal-acceptance-heading"
    ...
    >
                ...
                <div className="min-w-0 flex-1">
                  <label htmlFor={inputId} className="flex cursor-pointer items-start gap-2">
                    <input
                      ...
                      aria-describedby="partner-legal-acceptance-hint partner-legal-acceptance-error"
      ...
      {error && (
        <p
          id="partner-legal-acceptance-error"
...
export { PARTNER_LEGAL_ACCEPTANCE_MESSAGE };
