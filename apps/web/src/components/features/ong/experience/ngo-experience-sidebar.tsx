...
export function NgoExperienceSidebar({ ngoName, accessLevel, statusLabel, statusTone }: Props) {
  ...
  return (
    <aside className="hidden w-72 shrink-0 flex-col border-r border-zinc-200/80 bg-white/80 backdrop-blur-xl dark:border-white/10 dark:bg-zinc-950/80 lg:flex">
      ...
      <nav className="flex-1 space-y-0.5 overflow-y-auto p-3" aria-label={t("ngoArea.area")}>
