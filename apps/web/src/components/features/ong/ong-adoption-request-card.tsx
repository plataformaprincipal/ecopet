...
export function OngAdoptionRequestCard({ listing }: OngAdoptionRequestCardProps) {
  ...
  return (
    <article className="flex flex-col gap-3 rounded-2xl border border-zinc-200/80 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-card sm:flex-row sm:items-center sm:justify-between">
