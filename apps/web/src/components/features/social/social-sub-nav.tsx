...
export function SocialSubNav() {
  ...
  return (
    <nav
      className="sticky top-16 z-30 -mx-4 border-b border-ecopet-gray/10 bg-white/90 px-4 backdrop-blur-md dark:border-white/10 dark:bg-card/90 lg:-mx-6 lg:px-6"
