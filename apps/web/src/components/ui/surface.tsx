...
const surfaceVariants = cva("rounded-[var(--radius-lg)]", {
  variants: {
    variant: {
      base: "bg-[var(--surface)] text-[var(--ep-fg)]",
      elevated: "bg-[var(--surface-elevated)] text-[var(--ep-fg)] shadow-[var(--shadow-md)]",
      muted: "bg-[var(--surface-muted)] text-[var(--ep-fg)]",
      interactive:
        "bg-[var(--surface)] text-[var(--ep-fg)] shadow-[var(--shadow-sm)] transition-shadow hover:shadow-[var(--shadow-md)]",
